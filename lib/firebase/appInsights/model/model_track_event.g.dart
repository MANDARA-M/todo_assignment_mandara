...
part of 'model_track_event.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelTrackEvent _$ModelTrackEventFromJson(Map<String, dynamic> json) =>
    ModelTrackEvent(
      event: $enumDecode(_$AnalyticsEventsEnumMap, json['event']),
      eventProperties: json['eventProperties'] as Map<String, dynamic>,
    );

Map<String, dynamic> _$ModelTrackEventToJson(ModelTrackEvent instance) =>
    <String, dynamic>{
