...
part of 'model_event_common.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelEventCommon _$ModelEventCommonFromJson(Map<String, dynamic> json) =>
    ModelEventCommon(
      sessionId: json['sessionId'] as String,
      event: $enumDecode(_$AnalyticsEventsEnumMap, json['event']),
    )..eventTime = json['eventTime'] as String;

Map<String, dynamic> _$ModelEventCommonToJson(ModelEventCommon instance) =>
    <String, dynamic>{
